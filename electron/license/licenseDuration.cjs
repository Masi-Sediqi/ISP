...
function calculateLicenseEndDate(startDate, licenseType, customEndDate = "") {
...
function buildLicensePeriod(startDate, endDate, licenseType) {
...
module.exports = {
  ...
  buildLicensePeriod,
  calculateEndDate: calculateLicenseEndDate,
