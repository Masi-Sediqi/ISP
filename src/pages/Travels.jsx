...
function Travels() {
  ...
  const deleteDestination = (destination) => {
    ...
    if (!window.confirm(`آیا مقصد «${destination.name}» حذف شود؟`)) return;
  ...
  const deleteTravel = (travelIndex) => {
    if (!window.confirm("آیا این سفر حذف شود؟ رکوردهای مشتری و مصارف مربوط نیز حذف می‌شوند.")) return;
  ...
  return (
    <div className="travels-page">
      ...
      {showDestinationModal && (
        <div className="travel-modal-backdrop" onClick={closeDestinationModal}>
            ...
            <form onSubmit={saveDestination}>
              <div className="travel-form-grid">
                ...
                <div className="form-group">
                  ...
                  <input type="number" min="0" value={destinationForm.kilometers} onChange={(event) => setDestinationForm({ ...destinationForm, kilometers: event.target.value })} required />
                </div>
      ...
      {showTravelModal && (
        <div className="travel-modal-backdrop" onClick={closeTravelModal}>
          <div className="travel-modal" onClick={(event) => event.stopPropagation()}>
            ...
            <form onSubmit={saveTravel}>
              <div className="travel-form-grid">
                ...
                <div className="form-group"><label>کیلومتر تا مقصد</label><input type="number" min="0" value={travelForm.kilometers} onChange={(event) => setTravelForm({ ...travelForm, kilometers: event.target.value })} required /></div>
